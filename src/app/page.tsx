    ...
    <div className="space-y-12">
      <section className="relative text-center py-16 bg-gradient-to-br from-blue-900 via-gray-900 to-black text-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="flex justify-center gap-6 mt-8">
          <a href="/movies" className="px-8 py-3 bg-blue-600 hover:bg-blue-700 rounded-full text-lg font-semibold shadow-lg transition">Utforska Filmer</a>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="p-8 bg-white/90 rounded-2xl shadow-xl backdrop-blur-md border border-gray-200 hover:scale-105 transition-transform">
